...
if __name__ == "__main__":
    ...
    for data_size in [600]:
        ...
        for j in range(1):
            ...
            k_max = (
                100  # number of features in the latent space (after the truncated SVD).
            )
            ...
            if not os.path.exists(log_dir):
                ...
                with open(
                    f"{problem}/{method}_{problem}_{adap_type}/log_{data_size}_{adap_type}.txt",
                    "w",
                ) as log_file:
                    log_file.write("")
            logging.basicConfig(
                filename=f"{problem}/{method}_{problem}_{adap_type}/log_{data_size}_{adap_type}.txt",
                level=logging.INFO,
            ...
            trainor.fit(
                x_train,
                y_train,
                training_key=jrandom.PRNGKey(49),
