...
if __name__ == "__main__":
    ...
    for data_size in [600]:
        ...
        for j in range(1):
            ...
            loss_type = (
                "Contractive"  # Specify the loss type, according to the model chosen.
            )

            # Step 3: Specify the archietectures' parameters:
            latent_size = 512  # latent space dimension 200
            k_max = (
                512  # number of features in the latent space (after the truncated SVD).
            )
            ...
            training_kwargs = {
                ...
                #}
                "loss_kwargs": {"beta": 0.001, "find_weight": lambda model: model.encode.layers[-2].layers[0].weight},
