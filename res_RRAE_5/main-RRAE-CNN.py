...
if __name__ == "__main__":
    ...
    k_max = 5  # number of features in the latent space (after the truncated SVD).
    ...
    training_kwargs = {
        "step_st": [int(40000)], #c aprox 30 epoch (30*202000/256)
        "batch_size_st": [32], #c
        "lr_st": [1e-4, 1e-5, 1e-6, 1e-7, 1e-8], #c
        "print_every": 1,
        # "save_every": 1800,
        "sharding": sharding,
