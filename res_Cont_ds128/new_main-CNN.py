...
if __name__ == "__main__":
    ...
    loss_type = "contract"  # Specify the loss type, according to the model chosen.
    # Step 3: Specify the archietectures' parameters:
    latent_size = 100  # latent space dimension
    ...
    training_kwargs = {
        "step_st": [int(3000), int(3000)], # aprox 30 epoch (30*202000/256)
        "batch_size_st": [128, 128],
        ...
        "loss_type": loss_type,
        "loss_kwargs": {"beta": 0.1, "find_weight": lambda model: model.encode.layers[-2].layers[0].weight}
    }
