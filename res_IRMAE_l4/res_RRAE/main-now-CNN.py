    ...
    for data_size in [600]:
        ...
        for j in range(1):
            ...
            (
                ...
                pre_func_out,
                args,
            ) = get_data(problem, google=data_size, folder="../cifar-10-batches-py/")
            ...
            k_max = (
                200  # number of features in the latent space (after the truncated SVD).
            )
